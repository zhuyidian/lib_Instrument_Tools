package com.remoteplatform.commom.thread;
...
public class HomeExecutors {
    ...
    private HomeExecutors() {
        ...
        handlerThread = new HandlerThread("home-io-task");
        handlerThread.start();
        mainHandler = new Handler(Looper.getMainLooper());
        newthread = Executors.newCachedThreadPool(new IoThreadFactory("home-io-"));
    }
