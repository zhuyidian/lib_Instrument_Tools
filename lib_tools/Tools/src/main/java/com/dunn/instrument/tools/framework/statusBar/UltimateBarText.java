package com.dunn.instrument.tools.framework.statusBar;
...
public class UltimateBarText {
    ...
    private static void reMeasure(Activity activity) {
     ...
     * activity中使用:StatusBarUtil.setStatusBarLightMode(getWindow());
     */
