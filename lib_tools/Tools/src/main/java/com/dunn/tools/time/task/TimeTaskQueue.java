...
public class TimeTaskQueue {
    ...
    public boolean addTimeTask(int cmdType, TimeBean bean, RemoteCommand command, IAbility ability) {
        ...
        TimeTaskBean timeTaskBean = new TimeTaskBean(cmdType, bean, command, ability);
