...
public class AbilityManager {
    ...
    public void onNewMessage(Context context, int cmdType, String json) {
        if(cmdType == CMD_TYPE.shutdown.getValue() ||
            ...
            java.lang.reflect.Type type = new TypeToken<TimePlan>() {}.getType();
            try {
                //TimePlan plan = gson.fromJson(json, TimePlan.class);
                final TimePlan plan = gsonBuilder.fromJson(json, type);
                ...
                if (plan.getWeek() != null) {
                    List<TimePlan.Day> listWeek = plan.getWeek();
                    int size = listWeek.size();
                    LogUtil.i(TAG, "week.size=" + size);
                    for (int i = 0; i < size; i++) {
                        LogUtil.i(TAG, "week.number=" + ((TimePlan.Day)listWeek.get(i)).getNumber() + ", week.time=" + ((TimePlan.Day)listWeek.get(i)).getTimeX());
                    }
                }
                LogUtil.i(TAG, "month=" + plan.getMonth());

                if (plan.getMonth() != null) {
                    List<TimePlan.Day> listMonth = plan.getMonth();
                    int size = listMonth.size();
                    LogUtil.i(TAG, "month.size=" + size);
                    LogUtil.i(TAG, "month.number=" + ((TimePlan.Day)listMonth.get(0)).getNumber() + ", month.time=" + ((TimePlan.Day)listMonth.get(0)).getTimeX());
                    LogUtil.i(TAG, "month.number=" + ((TimePlan.Day)listMonth.get(1)).getNumber() + ", month.time=" + ((TimePlan.Day)listMonth.get(1)).getTimeX());
                    LogUtil.i(TAG, "month.number=" + ((TimePlan.Day)listMonth.get(2)).getNumber() + ", month.time=" + ((TimePlan.Day)listMonth.get(2)).getTimeX());
                    LogUtil.i(TAG, "month.number=" + ((TimePlan.Day)listMonth.get(3)).getNumber() + ", month.time=" + ((TimePlan.Day)listMonth.get(3)).getTimeX());
                    LogUtil.i(TAG, "month.number=" + ((TimePlan.Day)listMonth.get(4)).getNumber() + ", month.time=" + ((TimePlan.Day)listMonth.get(4)).getTimeX());
                    LogUtil.i(TAG, "month.number=" + ((TimePlan.Day)listMonth.get(5)).getNumber() + ", month.time=" + ((TimePlan.Day)listMonth.get(5)).getTimeX());
//                    for (int i = 0; i < size; i++) {
