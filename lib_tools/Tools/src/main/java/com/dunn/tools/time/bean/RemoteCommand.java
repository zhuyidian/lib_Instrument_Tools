...
//            Utils.startService(context, intent);
    ...
    public ReplyBuilder replyReceived(Context context) {
        return new ReplyBuilder(context, this, TimeConstant.COMMAND_STATUS_RECEIVE);
    }

    public ReplyBuilder replyProcessing(Context context) {
        return new ReplyBuilder(context, this, TimeConstant.COMMAND_STATUS_PROCESSING);
    }

    public ReplyBuilder replyFinish(Context context) {
        return new ReplyBuilder(context, this, TimeConstant.COMMAND_STATUS_FINISH);
    }

    public ReplyBuilder replyError(Context context) {
        return new ReplyBuilder(context, this, TimeConstant.COMMAND_STATUS_EXCEPTION);
    }
